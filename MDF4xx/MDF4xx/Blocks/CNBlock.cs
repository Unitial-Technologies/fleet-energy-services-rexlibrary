...
using LinkEnum = MDF4xx.Blocks.CNLinks;

namespace MDF4xx.Blocks
{
    internal enum CNLinks
    {
        /// <summary>
    ...
    /// Channel Block
    /// </summary>
    internal class CNBlock : BaseBlock
    {
        /// <summary>
